...
export default function MissionPage() {
  ...
  const values = [
    {
      ...
      description: locale === 'ar'
        ...
        : 'Discipline, accountability, and a strong commitment to sports ethics'
    },
    {
      icon: Shield,
      ...
      description: locale === 'ar'
        ...
        : 'Dedication and devotion towards achieving the Federation\'s vision and mission'
    },
    {
      icon: Star,
      ...
      description: locale === 'ar'
        ...
        : 'Empowering community members to build self-confidence, enabling them to protect themselves, their families, and their community'
    },
    {
      icon: Users,
      ...
      description: locale === 'ar'
        ...
        : 'Equipping athletes with the highest level of athletic skills and professionalism to compete on a global stage'
    },
    {
      icon: Lightbulb,
      ...
      description: locale === 'ar'
        ...
        : 'Adherence to national and international sports quality and excellence standards'
    },
    {
      icon: HandshakeIcon,
      ...
      description: locale === 'ar'
        ...
        : 'Fostering a culture of teamwork uniting all individuals toward common goals'
    },
    {
      icon: Trophy,
  ...
  return (
    <div className={`min-h-screen bg-background-100 ${locale === 'ar' ? 'rtl' : 'ltr'}`}>
      ...
      <div className="container mx-auto px-4 pt-32 pb-24 border-b border-primary/30">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-xl bg-gradient-to-br from-background-300 to-background-400 "
                >
                  {/* Corner Decorations */}
                ...
                <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-primary/60"></div> */}
                  ...
                  <div className="p-8 relative z-10">
                    ...
                    {/* Content */}
                    <p className="text-white text-center text-xl leading-relaxed mt-6">
                      {locale === 'ar'
                ...
                <motion.div
                  variants={itemVariants}
                  className="relative overflow-hidden rounded-xl bg-gradient-to-br from-background-300 to-background-400  group"
                >
                  {/* Corner Decorations */}
